...
class Template:
    ...
    def _get_list_from_message(self, messages):
        ...
        assert (
            len(question_list) == len(answer_list)
    ...
    def make_labels(self, input_ids, prompt, tokenizer):
        ...
        labels, cur_len = self._make_masks(
            labels, tokenizer, sep, eos_token_length, rounds
        )
    ...
    def _make_masks(self, labels, tokenizer, sep, eos_token_length, rounds):
        ...
        for rou in rounds:
            ...
            parts[0] += sep
            round_len = (
                len(self.tokenizer_image_token(rou, tokenizer)) + eos_token_length
            )
