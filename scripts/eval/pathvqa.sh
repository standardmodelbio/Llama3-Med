...
python -m llama3med.eval.run_eval \
    --gt $EVAL_DIR/vqa_path/test_llava.json \
    --candidate $EVAL_DIR/vqa_path/candidate.json \
    --pred $EVAL_DIR/vqa_path/answers/$MODEL_NAME.jsonl